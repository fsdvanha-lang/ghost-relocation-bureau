  ...
  return (
    <aside className="w-64 bg-[#0d121d] border-r border-[#1a2234] flex flex-col shrink-0 h-screen sticky top-0 select-none z-20">
      ...
      <div className="px-3 pb-3 border-t border-[#1a2234] pt-2">
        <button
          onClick={resetToSeed}
          className="w-full flex items-center justify-center gap-1.5 px-2 py-1.5 text-slate-500 hover:text-slate-300 rounded text-[11px] transition-colors hover:bg-[#131b2b]"
